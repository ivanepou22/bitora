codeunit 50000 "API - Send Sales Document"
{
    ...
    var
        ...
        EmptyEmailErr: Label 'The send-to email is empty. Specify email either for the customer or for the %1 in email preview.', Comment = '%1 - Document type';
    ...
    begin
        ...
        JobQueueEntry."Object ID to Run" := Codeunit::"API - Send Sales Document";
    ...
    begin
        ...
        DocumentMailing.EmailFileWithSubjectAndReportUsage(
         EmptyInStream, '', TempBlobEmailBody, StrSubstNo(CancelationEmailSubjectTxt, TempSalesHeader."Document Type"::"Credit Memo"),
