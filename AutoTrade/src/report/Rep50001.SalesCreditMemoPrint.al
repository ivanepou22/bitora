report 50001 "Sales Credit Memo - Print"
{

    DefaultLayout = RDLC;
    RDLCLayout = './Sales Credit Memo.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(Commission_AgentCaption; CommissionAgent)
                    {
                    }
                    column(SalesHeader_CommissionAgent; CommissionAgent)
                    {
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(Desc_2_SalesLine; "Sales Line"."Description 2")
                        {
    ...
    /// InitializeRequest.
    /// </summary>
    /// <param name="NoOfCopiesFrom">Integer.</param>
    /// <param name="ShowInternalInfoFrom">Boolean.</param>
    /// <param name="ArchiveDocumentFrom">Boolean.</param>
    /// <param name="LogInteractionFrom">Boolean.</param>
    /// <param name="PrintFrom">Boolean.</param>
